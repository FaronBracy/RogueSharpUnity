...
namespace Completed
{
	public class BoardManager : MonoBehaviour
	{
		...
		public int columns = 60; 										         //Number of columns in our game board.
		public int rows = 40;											         //Number of rows in our game board.
      ...
      void BoardSetup ()
		{
		   var mapCreationStrategy = new RandomRoomsMapCreationStrategy<Map>( columns, rows, 20, 18, 6 );
